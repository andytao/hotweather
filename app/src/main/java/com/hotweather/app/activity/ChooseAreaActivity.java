...
public class ChooseAreaActivity extends Activity {
    ...
    private void queryCounties() {
        countyList = hotWeatherDB.loadCounties(selectedCity.getId());
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if ("province".equals(type)) {
                    ...
                    result = Utility.handleCitiesResponse(hotWeatherDB, response, selectedProvince.getId());
                } else if ("county".equals(type)) {
                    result = Utility.handleCountiesResponse(hotWeatherDB, response, selectedCity.getId());
                }
                if (result) {
            ...
            public void onError(Exception e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(ChooseAreaActivity.this, "loading is failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
